...
try:
    ...
    NUM_CLASSES = len(point_history_classifier_labels)
    print(f"Training for {NUM_CLASSES} classes: {point_history_classifier_labels}")
...
model = tf.keras.models.Sequential([
    tf.keras.Input((TIME_STEPS * DIMENSION, )),
